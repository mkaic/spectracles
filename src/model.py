...
class Spectracles(nn.Module):
    def __init__(
        ...
        for _ in range(blocks):
            ...
            self.pixel_mag_exps.append(MagNorm(width, pow=0.5))
            self.post_ifft_mlps.append(ComplexMLP(width, depth=mlp_depth))

        self.out_mag_exp = MagNorm(width, pow=1.0)
